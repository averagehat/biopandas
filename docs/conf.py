...
project = your_project.__projectname__
copyright = '2015, ' + your_project.__authors__
...
release = your_project.__release__
...
latex_documents = [
    (
        master_doc,
        your_project.__projectname__ + '.tex',
        your_project.__projectname__ + ' Documentation',
        your_project.__authors__,
        'manual'
    ),
]
